...
class _BookSearchPageState extends State<BookSearchPage> {
  ...
  Future<List<Book>> adicionarLivros(String title) async {
    List<Book> livros = await _repositorio.recuperarLivro();
    Book newBook = Book(title: title);
    livros.add(newBook);
    await _repositorio.salvarLivro(livros);
    return livros;
  }
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    trailing: IconButton(
                      icon: Icon(Icons.add),
                      onPressed: () async {
                        adicionarLivros(book.title).then((livrosAtualizados) {
                          setState(() {
                            _readingList.clear();
                            _readingList.addAll(livrosAtualizados);
                          });
                        });
                      },
                    ),
